...
def vytvor_rytire():
    ...
    #while True:
    zbroj = seznam_vybaveni[0]#(input("Zadej druh zbroje - zadna,kozena,krouzkova,platova: ")).lower()
...
def priprava_utoku():
    ...
    # Vyber drevce
    #while True:
    drevec = seznam_vybaveni[1]#(input ("Zvol si drevec lehky/stredni/tezky: ")).lower()
    ...
    # Vyber ryhlosti       
    #while True:
    rychlost = seznam_vybaveni[2]#(input("Zadej rychlost kone cval/klus/trysk: ")).lower()
